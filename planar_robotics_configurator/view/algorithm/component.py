...
from planar_robotics_configurator.view.algorithm.parameters import SimulationParameters
...
class AlgorithmConfigurationComponent(MDFloatLayout, Component):
    ...
    def on_select(self, _):
        ...
        self.set_simulation(self.configuration)

    def set_simulation(self, simulation: AlgorithmConfiguration):
        self.configuration = simulation
        self.side_information.set_simulation(self.configuration)
        self.parameters.set_simulation(self.configuration)
